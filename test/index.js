...
it('do a pull-request with a version update', function(done)
{
  ...
  github.get('/repos/piranna/buho/git/refs/heads/master')
    .reply(200, require('./fixtures/success2.json'), { server: 'GitHub.com',
    ...
    .reply(201, require('./fixtures/success3.json'), { server: 'GitHub.com',
      date: 'Sun, 03 Jul 2016 14:21:04 GMT',
      'content-type': 'application/json; charset=utf-8',
      'content-length': '296',
      connection: 'close',
      ...
      location: 'https://api.github.com/repos/piranna/buho/git/refs/heads/Update_to_6.2.2',
      'x-github-media-type': 'github.v3; format=json',
      'access-control-expose-headers': 'ETag, Link, X-GitHub-OTP, X-RateLimit-Limit, X-RateLimit-Remaining, X-RateLimit-Reset, X-OAuth-Scopes, X-Accepted-OAuth-Scopes, X-Poll-Interval',
      'access-control-allow-origin': '*',
      'content-security-policy': 'default-src \'none\'',
    ...
    .post('/repos/piranna/buho/git/blobs', require('./fixtures/request4.json'))
      .reply(201, require('./fixtures/success4.json'), { server: 'GitHub.com',
    ...
    .get('/repos/piranna/buho/git/refs/heads/Update_to_6.2.2')
      .reply(200, require('./fixtures/success5.json'), { server: 'GitHub.com',
      date: 'Sun, 03 Jul 2016 14:21:05 GMT',
      'content-type': 'application/json; charset=utf-8',
      'transfer-encoding': 'chunked',
      connection: 'close',
    ...
    .get('/repos/piranna/buho/git/commits/89171258d1edd70f5c72c242c8e2262a97396e7e')
      .reply(200, require('./fixtures/success6.json'), { server: 'GitHub.com',
    ...
    .post('/repos/piranna/buho/git/trees', require('./fixtures/request7.json'))
      .reply(201, require('./fixtures/success7.json'), { server: 'GitHub.com',
      date: 'Sun, 03 Jul 2016 14:21:06 GMT',
      'content-type': 'application/json; charset=utf-8',
      'content-length': '1452',
      connection: 'close',
    ...
    .post('/repos/piranna/buho/git/commits', require('./fixtures/request8.json'))
      .reply(201, require('./fixtures/success8.json'), { server: 'GitHub.com',
    ...
    .patch('/repos/piranna/buho/git/refs/heads/Update_to_6.2.2', require('./fixtures/request9.json'))
      .reply(200, require('./fixtures/success9.json'), { server: 'GitHub.com',
      date: 'Sun, 03 Jul 2016 14:21:07 GMT',
      'content-type': 'application/json; charset=utf-8',
      'transfer-encoding': 'chunked',
      connection: 'close',
    ...
    .post('/repos/piranna/buho/pulls', require('./fixtures/request10.json'))
      .reply(201, require('./fixtures/success10.json'), { server: 'GitHub.com',
